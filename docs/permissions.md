...
| Module         | Keys                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ADMINISTRATION | `organization.view/manage`, `company.view/manage`, `branch.view/manage`, `user.view/create/update/deactivate`, `role.view/manage/assign`, `sod.manage`, `workflow.manage`, `approval.view/decide`, `attachment.view/manage`, `numbering.view/manage`, `import.view/run`, `operations.view/manage` (view restricted like `audit.view`)                                                                                                                                                                          |
| ACCOUNTING     | `account.view/manage`, `journal.view/create/submit/approve/post/reverse`, `period.view/manage/close/reopen/lock/post-soft-closed`, `journal.correct`, `integrity.check`, `reconciliation.view/prepare/approve`, `policy.manage`, `close.view/manage/approve`, `controls.view`, `history.view`, `opening-balance.view/manage`, `exchange-rate.view/manage`, `fx.revalue`, `intercompany.view/post`, `revenue.view/manage/recognize` (Prompt #10: policies & milestones vs posting / reversing recognition runs) |
...
| BANKING        | `bank-account.view/manage`, `bank-transaction.create/post`, `bank-statement.import`, `bank-reconciliation.perform`, `treasury.view/forecast-manage`, `treasury-settings.manage`, `bank-transfer.create/approve/post`, `payment-file.manage`, `petty-cash.manage/approve/post`, `bank-feed.manage` (Prompt #12: matching rules, feed settings, applying / dismissing suggestions; reads use `bank-account.view`)                                                                                                |
| FIXED_ASSETS   | `fixed-asset.view/manage/post`, `depreciation.run`, `lease.view/manage/post` (Prompt #13: contracts and settings are `manage`; commencing, running, paying, remeasuring and terminating post and need `post`; the asset split is `fixed-asset.manage`)                                                                                                                                                                                                                                                         |
| BUDGETING      | `budget.view/manage/approve`, `dimension.view/manage`, `expense-claim.view/create/approve/post`                                                                                                                                                                                                                                                                                                                                                                                                                |
| TAX            | `tax.view/manage`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| REPORTING      | `reports.view/export`, `consolidation.view/manage/run/approve`, `report-definition.manage`, `trace.view` (restricted like `audit.view`: not part of the viewer bundle)                                                                                                                                                                                                                                                                                                                                         |
| AUDIT          | `audit.view`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| PAYROLL        | `employee.view/manage`, `payroll.view/manage/approve/post` (Prompt #11; `employee.view` and `payroll.view` are restricted like `audit.view`: accounting, finance and audit roles only; `payroll.approve` is delegable)                                                                                                                                                                                                                                                                                         |
...
| Payroll preparer vs approver            | `payroll.manage` + `payroll.approve`                              |
| Petty cash preparer vs approver         | `petty-cash.manage` + `petty-cash.approve` (above the fund limit) |
| Consolidation preparer vs approver      | `consolidation.run` + `consolidation.approve`                     |
