...
| ACCOUNTING     | `account.view/manage`, `journal.view/create/submit/approve/post/reverse`, `period.view/manage/close/reopen/lock/post-soft-closed`, `journal.correct`, `integrity.check`, `reconciliation.view/prepare/approve`, `policy.manage`, `close.view/manage/approve`, `exchange-rate.view/manage`, `fx.revalue`, `intercompany.view/post` |
