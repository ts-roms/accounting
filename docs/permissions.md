...
| ACCOUNTING     | `account.view/manage`, `journal.view/create/submit/approve/post/reverse`, `period.view/manage/close/reopen/lock/post-soft-closed`, `journal.correct`, `integrity.check`, `reconciliation.view/prepare/approve`, `policy.manage`, `exchange-rate.view/manage`, `fx.revalue`, `intercompany.view/post` |
...
| `FINANCE_MANAGER`                    | Approves and posts, reverses, closes periods, runs depreciation and reconciliation.             |
