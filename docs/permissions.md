...
| ACCOUNTING     | `account.view/manage`, `journal.view/create/submit/approve/post/reverse`, `period.view/manage/close/reopen`, `exchange-rate.view/manage`, `fx.revalue`, `intercompany.view/post`                                                                        |
