...
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Something was never delivered / imported / pushed              | Administration -> Integrations -> **Operations**: the dead-letter queue lists exhausted deliveries, failed events and failed jobs with the error; replay or discard from there (audited).                          |
