...
export const NAVIGATION: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('Bank Feed Review', '/banking/feed', Inbox, [P['bank-account.view']], 'Banking'),
      item(
        'Bank Feed Rules',
        '/banking/feed/rules',
        ListChecks,
      ...
      item('Bank Feed KPIs', '/banking/feed/dashboard', Gauge, [P['bank-account.view']], 'Banking'),
      ...
      item('Leases', '/leases', FileSignature, [P['lease.view']], 'Leases'),
      item('Lease Runs', '/leases/runs', CalendarCheck, [P['lease.view']], 'Leases'),
      item('Lease Reports', '/leases/reports', BarChart3, [P['lease.view']], 'Leases'),
