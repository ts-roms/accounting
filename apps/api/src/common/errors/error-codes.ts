...
export const ErrorCodes = {
  ...
  ACCOUNT_BRANCH_NOT_ALLOWED: 'ACCOUNT_BRANCH_NOT_ALLOWED',
  DIMENSION_REQUIRED: 'DIMENSION_REQUIRED',
  POSTING_RULE_UNRESOLVED: 'POSTING_RULE_UNRESOLVED',
  RECURRING_JOURNAL_INVALID_STATE: 'RECURRING_JOURNAL_INVALID_STATE',
  PREPAYMENT_INVALID_STATE: 'PREPAYMENT_INVALID_STATE',
  ...
  // Accounts receivable (Prompt #6)
  CREDIT_HOLD: 'CREDIT_HOLD',
  CREDIT_CHECK_FAILED: 'CREDIT_CHECK_FAILED',
  INVOICE_DISPUTED: 'INVOICE_DISPUTED',
  WRITE_OFF_INVALID: 'WRITE_OFF_INVALID',
  // Prompt #7 - accounts payable
  VENDOR_ON_HOLD: 'VENDOR_ON_HOLD',
  VENDOR_NOT_APPROVED: 'VENDOR_NOT_APPROVED',
  BILL_ON_HOLD: 'BILL_ON_HOLD',
  PAYMENT_RUN_INVALID: 'PAYMENT_RUN_INVALID',
  ACCRUAL_INVALID: 'ACCRUAL_INVALID',
  // Consolidation (Prompt #9)
  CONSOLIDATION_NOT_READY: 'CONSOLIDATION_NOT_READY',
  INTERCOMPANY_MISMATCH: 'INTERCOMPANY_MISMATCH',
  // Revenue recognition (Prompt #10)
  REVENUE_SCHEDULE_INVALID: 'REVENUE_SCHEDULE_INVALID',
  REVENUE_RECOGNIZED: 'REVENUE_RECOGNIZED',
  REVENUE_RUN_INVALID_STATE: 'REVENUE_RUN_INVALID_STATE',
  // Payroll (Prompt #11)
  PAY_RUN_INVALID_STATE: 'PAY_RUN_INVALID_STATE',
  PAY_ITEM_INVALID: 'PAY_ITEM_INVALID',
  EMPLOYEE_INACTIVE: 'EMPLOYEE_INACTIVE',
  // Bank feed (Prompt #12)
  BANK_SUGGESTION_INVALID: 'BANK_SUGGESTION_INVALID',
  BANK_RULE_INVALID: 'BANK_RULE_INVALID',
  // Leases (Prompt #13)
  LEASE_INVALID_STATE: 'LEASE_INVALID_STATE',
  LEASE_SCHEDULE_INVALID: 'LEASE_SCHEDULE_INVALID',
  LEASE_RUN_INVALID_STATE: 'LEASE_RUN_INVALID_STATE',
