...
export async function seedPayroll(
  ...
  for (const r of RUNS) {
    ...
    for (const e of active) {
      ...
      const [inserted] = await tx
        ...
        .values({
          ...
          net: slip.net,
          grossBase: slip.base.gross,
          taxableBase: slip.base.taxable,
          withholdingBase: slip.base.withholding,
          deductionsBase: slip.base.deductions,
          employerContributionsBase: slip.base.employerContributions,
          reimbursementsBase: slip.base.reimbursements,
          netBase: slip.base.net,
    ...
    const patch: Partial<schema.PayRun> = {
      ...
      // Seeded runs are in the base currency: base totals mirror the pay-currency totals.
      grossTotalBase: totals.gross.toString(),
      taxableTotalBase: totals.taxable.toString(),
      withholdingTotalBase: totals.withholding.toString(),
      deductionTotalBase: totals.deductions.toString(),
      employerTotalBase: totals.employer.toString(),
      reimbursementTotalBase: '0',
      netTotalBase: totals.net.toString(),
      paidBase: totals.net.toString(),
      calculatedAt: now,
      submittedAt: now,
